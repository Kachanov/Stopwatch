...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "minutesArrow", function() { return minutesArrow; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "secondsArrow", function() { return secondsArrow; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stopwatch_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stopwatch__ = __webpack_require__(1);
...
startPauseButton.onclick = () => {
    if(isStart === false) {
        __WEBPACK_IMPORTED_MODULE_2__stopwatch__["a" /* stopwatch */].start();
        isStart = true;
        startPauseButton.classList.add("isStart");
        startPauseButton.innerHTML = "Pause";
    }else{
        __WEBPACK_IMPORTED_MODULE_2__stopwatch__["a" /* stopwatch */].pause();
        isStart = false;
...
stopButton.onclick = () => {
    ...
    __WEBPACK_IMPORTED_MODULE_2__stopwatch__["a" /* stopwatch */].stop();
    laps = [];
    lapsCart.innerHTML = "";
};
...
lapButton.onclick = function() {
    laps.push(__WEBPACK_IMPORTED_MODULE_2__stopwatch__["a" /* stopwatch */].minutes + ":" + __WEBPACK_IMPORTED_MODULE_2__stopwatch__["a" /* stopwatch */].seconds);
    console.log(laps);
...
class Stopwatch{
    ...
    getTime() {
        __WEBPACK_IMPORTED_MODULE_0__main__["seconds"].innerHTML = this.seconds;
        __WEBPACK_IMPORTED_MODULE_0__main__["minutes"].innerHTML = this.minutes;

        if(this.seconds < 10){
            __WEBPACK_IMPORTED_MODULE_0__main__["seconds"].innerHTML = "0" + this.seconds;
        }
    }
    ...
    rotateSecondsArrow(){
        __WEBPACK_IMPORTED_MODULE_0__main__["secondsArrow"].style.transform = "rotate(" + this.seconds * 6 + "deg)";
    }

    rotateMinutesArrow(){
        __WEBPACK_IMPORTED_MODULE_0__main__["minutesArrow"].style.transform = "rotate(" + this.minutes * 6 + "deg)";
    }
